...
#UAV5 = np.array(uav_traj[4][:])

plt.plot(UAV1[:,0], UAV1[:,1], 'r-', linewidth=2, label='UAV 1')
plt.plot(UAV2[:,0], UAV2[:,1], 'b-', linewidth=2, label='UAV 2')
plt.plot(UAV3[:,0], UAV3[:,1], 'g-', linewidth=2, label='UAV 3')
plt.plot(UAV4[:,0], UAV4[:,1], 'm-', linewidth=2, label='UAV 4')
#plt.plot(UAV5[:,0], UAV5[:,1], 'c-', linewidth=2, label='UAV 5')

plt.plot(UAV1[0,0], UAV1[0,1], 'ro', markersize=10)
plt.plot(UAV2[0,0], UAV2[0,1], 'bo', markersize=10)
plt.plot(UAV3[0,0], UAV3[0,1], 'go', markersize=10)
plt.plot(UAV4[0,0], UAV4[0,1], 'mo', markersize=10)
#plt.plot(UAV5[0,0], UAV5[0,1], 'co', markersize=10)

plt.plot(UAV1[-1,0], UAV1[-1,1], 'rd', markersize=10)
plt.plot(UAV2[-1,0], UAV2[-1,1], 'bd', markersize=10)
plt.plot(UAV3[-1,0], UAV3[-1,1], 'gd', markersize=10)
plt.plot(UAV4[-1,0], UAV4[-1,1], 'md', markersize=10)
#plt.plot(UAV5[-1,0], UAV5[-1,1], 'cd', markersize=10)
